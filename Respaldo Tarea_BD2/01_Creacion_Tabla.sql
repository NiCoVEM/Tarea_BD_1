...
-- CREAR ArticulosSimple ANTES de Participantes
...
-- Luego sí puedes crear Participantes
...
BEGIN
	...
	-- Número aleatorio de autores (entre 1 y 3)
	...
	-- Insertar artículo con el primer autor como contacto
    ...
    -- Insertar autor 1 como participante
    INSERT INTO Participantes (ID_Art, contacto) VALUES (@artID, @autor1);

	-- Si hay más autores, agrégalos (evitando duplicados)
	IF @numAutores >= 2
	BEGIN
